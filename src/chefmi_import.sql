...
"Primer paso del plato<br />Segundo paso del plato<br />Tercer paso del plato",2,25, 2, TRUE);
INSERT INTO platos (id_tipo, nombre, descripcion, ingredientes, preparacion, dificultad, tiempo, num_personas, estado)
