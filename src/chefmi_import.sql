...
INSERT INTO platos (id_tipo, nombre, descripcion, ingredientes, preparacion, dificultad, tiempo, num_personas, estado, votos, autor) 
VALUES (1,"Plato prueba 1", "Esto es un plato de ejemplo numero 1", "Ingrediente 1",
"Primer paso del plato<br />Segundo paso del plato<br />Tercer paso del plato",2,25, 2, TRUE,3, 'Chefmi');
INSERT INTO platos (id_tipo, nombre, descripcion, ingredientes, preparacion, dificultad, tiempo, num_personas, estado, autor)
VALUES (1,"Plato prueba 2", "Esto es un plato de ejemplo numero 2", "Ingrediente 1<br />Ingrediente 2",
"Primer paso del plato<br />Segundo paso del plato",3,67, 4, TRUE, 'Chefmi');
INSERT INTO platos (id_tipo, nombre, descripcion, ingredientes, preparacion, dificultad, tiempo, num_personas, estado, votos, autor)
VALUES (2,"Plato prueba 3", "Esto es un plato de ejemplo numero 3", "Ingrediente 1<br />Ingrediente 2<br />Ingrediente 3",
"Primer paso del plato",1,12, 1, TRUE, 3, 'Chefmi');

INSERT INTO platos (id_tipo, nombre, descripcion, ingredientes, preparacion, dificultad, tiempo, num_personas, estado, autor)
VALUES (2,"Plato prueba 4", "Esto es un plato de ejemplo numero 4", "Ingrediente 1<br />Ingrediente 2<br />Ingrediente 3",
"Primer paso del plato",1,12, 1, TRUE, 'Chefmi');
