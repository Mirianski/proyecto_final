        ...
        <?php foreach ($platos as $plato) : ?>
            <a href="?receta=<?php echo $plato["id_plato"]; ?>">
                <div class="max-w-xl w-full lg:max-w-full lg:flex m-3">
                    ...
                    <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex-1 justify-between leading-normal">
                        <div class="mb-8">
                        ...
                        <div class="flex items-center float-right">
                            <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 m-2">Categoría: <?php echo $tipo["nombre"]; ?></span>
                            <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 m-2">Tiempo: <?php echo $plato["tiempo"]; ?> min</span>
                            <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 m-2">Dificultad: <?php echo $plato["dificultad"]; ?>/5</span>
                        </div>
                    </div>
                </div>
            </a>
...
<?php if (isset($_GET["receta"])) { ?>
    ...
    <?php if($error != '') echo $error;?>
        <div class="text-center text-5xl"><h1><?php echo $plato["nombre"]; ?></h1></div>
        ...
        <h2>Preparación</h2>
        <div class="block text-gray-700 px-4 py-2 mt-2">
            <ul class="list-inside list-disc">
                ...
                <div class="w-full h-58 lg:flex m-3">
                    ...
                    <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex-1 justify-between leading-normal">
                        ...
                        <div class="flex items-center float-right m-2">
                            <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 m-2">Categoría: <?php echo $plato["categoria"]; ?></span>
                            <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 m-2">Tiempo: <?php echo $plato["tiempo"]; ?> min</span>
                            <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 m-2">Dificultad: <?php echo $plato["dificultad"]; ?>/5</span>
                        </div>
                    </div>
