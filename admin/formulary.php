<div id="formulary">
    ...
    <?php endif; ?>
            ...
            <div>
                ...
                <input type="number" name="tiempo" min="1" <?php if ($plato && isset($plato["tiempo"])) echo 'value="' . $plato["tiempo"] . '"' ?> required />
            </div>
            <div>
                <label for="dificultad">Dificultad (1 - 5):</label></br>
                <input type="number" name="dificultad" min="1" max="5" <?php if ($plato && isset($plato["dificultad"])) echo 'value="' . $plato["dificultad"] . '"' ?> required />
            </div>
            <div>
                <label for="num_personas">Num. personas:</label></br>
                <input type="number" name="num_personas" min="1" <?php if ($plato && isset($plato["num_personas"])) echo 'value="' . $plato["num_personas"] . '"' ?> required />
            </div>
            <?php if (!isset($_GET['editar_receta'])) : ?>
